...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'venues_venue', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Venue.name'
        db.alter_column(u'venues_venue', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
